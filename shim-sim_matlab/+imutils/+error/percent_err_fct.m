function [mean_percent_diff] = percent_err_fct(mask_fname, meas_b0_map_fname, sim_b0_map_fname, varargin)
%
...
mask_dBz = mask .* real(sim_b0_map_fname); %  sim_b0_map_fname should be complex double ppm
